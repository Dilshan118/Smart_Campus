...
│   │   │   ├── bookings/                      # Booking Cards, Calendar, QR Modals
│   │   │   ├── common/                        # Navbar, Sidebar, ProtectedRoute, ErrorBoundary
│   │   │   ├── notifications/                 # Notification Popovers & Lists
│   │   │   ├── resources/                     # Resource Grids, Search Filters
│   │   │   └── tickets/                       # SLA Countdowns, Ticket Lists, Triage UI
│   │   ├── context/                           # React Context (AuthContext, ToastContext)
│   │   ├── hooks/                             # Custom React Hooks
│   │   ├── pages/                             # Router Page Views
│   │   │   ├── admin/                         # User Management, Analytics Dashboards
│   │   │   ├── auth/                          # Login, OAuth Callback, Pending Approval Gate
│   │   │   ├── bookings/                      # Booking Creation, Management, Details
│   │   │   ├── dashboard/                     # User & Manager Overview Dashboards
│   │   │   ├── notifications/                 # Notification Center
│   │   │   ├── profile/                       # User Profile Settings
│   │   │   ├── resources/                     # Catalog, Resource Details, Smart Finder
│   │   │   └── tickets/                       # Ticket Submission, Details, Management
...
│
├── docs/                                      # Postman API Collections & Documentation
...
The repository contains a `vercel.json` file to handle single-page application (SPA) client-side routing.
